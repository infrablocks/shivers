...
describe Shivers::Parts::Alphanumeric do
  context 'equality' do
    it 'is equal to other of same type' do
      first = Shivers::Parts::Alphanumeric.new
      second = Shivers::Parts::Alphanumeric.new
    ...
    it 'is not equal to other of different type' do
      first = Shivers::Parts::Alphanumeric.new
      second = Class.new(Shivers::Parts::Alphanumeric).new
